...
export default function GetAllUsers() {
  ...
  const jsonData = `<ArrayOfUserXmlResponse xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <UserXmlResponse>
        <Id>101</Id>
  ...
  const jsCode = `
fetch("https://snap-test-api-v1.onrender.com/api/xml/UserXML/all")
  .then(res => res.text())
...
axios.get("https://snap-test-api-v1.onrender.com/api/xml/UserXML/all")
...
`;
  ...
  const phpCode = `
<?php
$url = "https://snap-test-api-v1.onrender.com/api/xml/UserXML/all";
...
`;
  ...
  const curlCode = `
curl -X GET "https://snap-test-api-v1.onrender.com/api/xml/UserXML/all"
`;
    ...
    <Stack direction="column" spacing={1} sx={{ width: "100%" }}>
      ...
      >
        ...
        <TextField
          ...
          variant="outlined"
          enabled={false}
          value="https://snap-test-api-v1.onrender.com/api/xml/UserXML/all"
